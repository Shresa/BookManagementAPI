...
Method              DELETE
*/
Bookly.delete("/book/delete/:isbn", async (req, res) => {
...
Method              DELETE
*/
Bookly.delete("/book/delete/author/:isbn/:authorId", async (req, res) => {
    // update the book database
...
Method              DELETE
*/
Bookly.delete("/publication/delete/book/:isbn/:pubId", (req, res) => {
